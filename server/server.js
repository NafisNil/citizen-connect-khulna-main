  ...
  <body>
    <div class="card">
      ...
      <div class="actions">
        ...
        <a class="secondary" href="/citizen-connect-khulna-main/">Go home</a>
      </div>
    </div>
  </body>
</html>`;
...
async function getServerEntry() {
	if (!serverEntryPromise) serverEntryPromise = import("./assets/server-BXQseWH5.js").then((m) => m.default ?? m);
